...
const staticPriceMap = {
  ...
  fireplace_no: { price: 0, label: "No - Above Fireplace", workizId: 1017 },
  ...
  wallFireplace: {
    price: 109,
    label: "In-Wall Concealment (Fireplace)",
    workizId: 1051,
  },
  socketFireplace: {
    price: 149,
    label: "In Wall with Socket (Fireplace)",
    workizId: 1052,
  },
  cableChannelBrick: {
    price: 52,
    label: "Cable channel (Brick)",
    workizId: 1053,
  },
  wallBrick: {
    price: 249,
    label: "In-Wall Concealment (Brick)",
    workizId: 1054,
  },
  socketBrick: {
    price: 289,
    label: "In-Wall with Socket (Brick)",
    workizId: 1055,
  },
