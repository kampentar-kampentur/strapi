...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta_override: Schema.Attribute.Component<'cta.cta-override', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiGallerPhotoGallerPhoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    objectPosition: Schema.Attribute.Text;
...
export interface ApiHeroTextLineHeroTextLine
  ...
  info: {
    displayName: 'HeroTextLine';
    pluralName: 'hero-text-lines';
    singularName: 'hero-text-line';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hero-text-line.hero-text-line'
    > &
      Schema.Attribute.Private;
...
export interface ApiTvMountingTypeTvMountingType
  ...
  info: {
    ...
    pluralName: 'tv-mounting-types';
    singularName: 'tv-mounting-type';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tv-mounting-type.tv-mounting-type'
    > &
      Schema.Attribute.Private;
...
export interface ApiWhyCustomersChooseUsWhyCustomersChooseUs
  ...
  info: {
    ...
    pluralName: 'why-customers-choose-uses';
    singularName: 'why-customers-choose-us';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::why-customers-choose-us.why-customers-choose-us'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subTitle: Schema.Attribute.Text;
